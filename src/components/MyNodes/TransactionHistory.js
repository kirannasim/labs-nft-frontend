...
// <section className="history--container">
//     <h3 className="history--container__title">TRANSACTION HISTORY</h3>
//     <table className="history--container__table">
//       <tbody>
//         {transactions.map((item, index) => (
//           <tr key={index} className="history--container__table--row">
//             <td className="col-1 col-symbol tex-start symbol">
//               <div className="img--container">
//                 <img src={symbolIcon} alt="symbol" />
//               </div>
//             </td>
//             <td className="col-3 col-look text-start">
//               <span className="bb_18">look distribution</span>
//             </td>
//             <td className="col-2 col-date text-left">
//               <div className="bb_18_medium pb-1">Date</div>
//               <div className="bb_22">4 june,2022</div>
//             </td>
//             <td className="col-2 col-time text-center">
//               <div className="bb_18_medium pb-1">Time</div>
//               <div className="bb_22">14:00</div>
//             </td>
//             <td className="col-2 col-amount">
//               <div className="bb_18_medium text-center pb-1">Amount</div>
//               <div className="bb_22">459.57</div>
//             </td>
//             <td className="col-2 col-button text-end">
//               <CustomButton
//                 button_name="See invoice"
//                 btn_class_name="btn-outline-primary"
//                 content_class_name="bb_16_medium"
